...
items8 = ['../static/Mainpage/img/sub1.png', '../static/Mainpage/img/sub2.png', '../static/Mainpage/img/sub3.png',
          '../static/Mainpage/img/sub6.png', '../static/Mainpage/img/sub7.png', '../static/Mainpage/img/sub9.png', '../static/Mainpage/img/sub10.png']
...
def items(request):
    ...
    return render(request, 'Mainpage/items.html',
                  {'teacher': random.choice(teachers), 'items1': random.choice(items1), 'items2': random.choice(items2),
                   'items3': random.choice(items3), 'items4': random.choice(items4), 'items5': random.choice(items5),
                   'items6': random.choice(items6), 'items7': random.choice(items7), 'items8': random.choice(items8),
                   'items9': random.choice(items9), 'items10': random.choice(items10)})
